...
@section('title')
    @lang('admin/user.titles.permission_edit')
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 style="margin:0">@lang('admin/user.titles.permission_edit')</h3>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form action="{{ route('admin.permission.update', ['id' => $permission->id]) }}" method="POST">
                                ...
                                <input type="text" hidden name="redirect_to" value="{{ URL::previous() }}">

                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    <label for="name">@lang('admin/user.labels.name')</label>
                                    <input type="text" disabled class="form-control" id="name" name="name" value="{{ $permission->name }}" placeholder="@lang('admin/user.labels.name')" autofocus>
                                    @if ($errors->has('name'))
